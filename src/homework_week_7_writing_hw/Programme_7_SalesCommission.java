...
public class Programme_7_SalesCommission {
    public static void main(String[] args) {
        ...
        int seleAmount = scanner.nextInt();
        ...
        int grossSalary = basicSalary + salesCommission.calculateCommission(seleAmount);
        System.out.println("Seller name is             : " + name);
        System.out.println("Seller id is               : " + sellerId);
        System.out.println("Seller's sales amount is   : " + seleAmount);
